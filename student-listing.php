<?php 
	...
	$SQL="SELECT * FROM `student`, `student_course`, `student_year`, `student_semester`, `student_department` WHERE student_course = course_id AND student_year = year_id AND student_department = department_id AND student_semester = semester_id";
			...
			<form name="frm_student" action="lib/student.php" method="post">
				<div class="static">
					...
					<div style="float:left; border:1px solid; margin:8px; padding:8px">
						<a href="student-details.php?student_id=<?php echo $data[student_id] ?>"><img src="<?=$SERVER_PATH.'uploads/'.$data[student_image]?>" style="height:180px; width:150px"></a><br>
