<?php 
	...
	$SQL="SELECT * FROM `student`, `student_gender`, `student_semester`, `student_course`, `student_department`, `student_year` WHERE student_semester = semester_id And student_gender = gender_id AND student_course = course_id AND student_department = department_id AND student_year = year_id";
